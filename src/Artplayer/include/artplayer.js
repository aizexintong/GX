...
! function(e, t, r, a, o) {
	...
	}, c.modules = e, c.cache = s, c.parent = i, c.register = function(t, r) {
		e[t] = [function(e, t) {
			t.exports = r
		}, {}]
	...
	if (r) {
		var u = c(r);
		"object" == typeof exports && "undefined" != typeof module ? module.exports = u : "function" == typeof define &&
	...
	"5lTcX": [function(e, t, r) {
		...
		class X extends c.default {
			constructor(e, t) {
				...
				if (r.container = e.container, this.option = (0, s.default)(r, d.default), this
					.isLock = !1, this.isReady = !1, this.isFocus = !1, this.isInput = !1, this
					.isRotate = !1, this.isDestroy = !1, this.template = new(0, g.default)(this),
					this.events = new(0, T.default)(this), this.storage = new(0, B.default)(this),
					this.icons = new(0, Y.default)(this), this.i18n = new(0, y.default)(this), this
					.notice = new(0, O.default)(this), this.player = new(0, x.default)(this), this
					.layers = new(0, z.default)(this), this.controls = new(0, j.default)(this), this
					.contextmenu = new(0, S.default)(this), this.subtitle = new(0, $.default)(this),
					this.info = new(0, C.default)(this), this.loading = new(0, D.default)(this),
					this.hotkey = new(0, F.default)(this), this.mask = new(0, V.default)(this), this
					.setting = new(0, W.default)(this), this.plugins = new(0, K.default)(this),
					"function" == typeof t && this.on("ready", (() => t.call(this, this))), X.DEBUG
					) {
					const e = e => console.log(`[ART.${this.id}] -> ${e}`);
					e("Version@" + X.version), e("Env@" + X.env), e("Build@" + X.build);
					for (let t = 0; t < h.default.events.length; t++) this.on("video:" + h.default
						.events[t], (t => e("Event@" + t.type)))
				}
				Z.push(this)
			}
			...
			destroy(e = !0) {
				this.events.destroy(), this.template.destroy(e), Z.splice(Z.indexOf(this), 1), this
					.isDestroy = !0, this.emit("destroy")
			}
		}
		if (r.default = X, X.DEBUG = !1, X.CONTEXTMENU = !0, X.NOTICE_TIME = 2e3, X.SETTING_WIDTH = 250, X
			.SETTING_ITEM_WIDTH = 200, X.SETTING_ITEM_HEIGHT = 35, X.RESIZE_TIME = 200, X.SCROLL_TIME = 200,
			X.SCROLL_GAP = 50, X.AUTO_PLAYBACK_MAX = 10, X.AUTO_PLAYBACK_MIN = 5, X.AUTO_PLAYBACK_TIMEOUT =
			3e3, X.RECONNECT_TIME_MAX = 5, X.RECONNECT_SLEEP_TIME = 1e3, X.CONTROL_HIDE_TIME = 3e3, X
			.DBCLICK_TIME = 300, X.DBCLICK_FULLSCREEN = !0, X.MOBILE_DBCLICK_PLAY = !0, X
			.MOBILE_CLICK_PLAY = !1, X.AUTO_ORIENTATION_TIME = 200, X.INFO_LOOP_TIME = 1e3, X
			.FAST_FORWARD_VALUE = 3, X.FAST_FORWARD_TIME = 1e3, X.TOUCH_MOVE_RATIO = .5, X.VOLUME_STEP = .1,
			X.SEEK_STEP = 5, X.PLAYBACK_RATE = [.5, .75, 1, 1.25, 1.5, 2], X.ASPECT_RATIO = ["default",
				"4:3", "16:9"
			], X.FLIP = ["normal", "horizontal", "vertical"], X.FULLSCREEN_WEB_IN_BODY = !1, "undefined" !=
			typeof document && !document.getElementById("Artplayer-style")) {
			const e = p.createElement("style");
			e.id = "Artplayer-style", e.textContent = n.default, document.head.appendChild(e)
		}
		"undefined" != typeof window && (window.Artplayer = X), console.log(
			`%c ArtPlayer %c ${X.version} %c https://artplayer.org`, "color: #fff; background: #5f5f5f",
		...
		t.exports = function() {
			...
			var t = Object.prototype.toString,
				r = function(r) {
					...
					if ("function" === o) return function(e) {
					...
					if (function(e) {
							return e instanceof Date || "function" == typeof e.toDateString &&
								"function" == typeof e.getDate && "function" == typeof e.setDate
						}(r)) return "date";
					if (function(e) {
							return e instanceof Error || "string" == typeof e.message && e
								.constructor && "number" == typeof e.constructor.stackTraceLimit
						}(r)) return "error";
					if (function(e) {
							return e instanceof RegExp || "string" == typeof e.flags && "boolean" ==
								typeof e.ignoreCase && "boolean" == typeof e.multiline && "boolean" ==
								typeof e.global
						}(r)) return "regexp";
					switch (a(r)) {
						case "Symbol":
					...
					if (function(e) {
							return "function" == typeof e.throw && "function" == typeof e.return &&
			...
			function o(e, t) {
				...
				return n(e, t, a), i(e, t, a),
					function(e, t, a) {
						var s = r(t),
							l = r(e);
						if ("object" === s) {
							if ("object" !== l) throw new Error("[Type Error]: '".concat(a.join("."),
								"' require 'object' type, but got '").concat(l, "'"));
						...
						if ("array" === s) {
							if ("array" !== l) throw new Error("[Type Error]: '".concat(a.join("."),
								"' require 'array' type, but got '").concat(l, "'"));
			...
			function n(e, t, a) {
				if ("string" === r(t)) {
					var o = r(e);
					if ("?" === t[0] && (t = t.slice(1) + "|undefined"), !(-1 < t.indexOf("|") ? t
							.split("|").map((function(e) {
								return e.toLowerCase().trim()
							})).filter(Boolean).some((function(e) {
								return o === e
							})) : t.toLowerCase().trim() === o)) throw new Error("[Type Error]: '"
						.concat(a.join("."), "' require '").concat(t, "' type, but got '")
						.concat(o, "'"))
				}
			}
			...
			function i(e, t, a) {
				if ("function" === r(t)) {
					...
					if (!0 !== o) {
						var n = r(o);
						throw "string" === n ? new Error(o) : "error" === n ? o : new Error(
							"[Validator Error]: The scheme for '".concat(a.join("."),
								"' validator require return true, but got '").concat(o, "'"))
					}
				}
			}
			return o.kindOf = r, o
		...
		r.default = class {
			...
			off(e, t) {
				const r = this.e || (this.e = {}),
					...
					o = [];
				if (a && t)
					for (let e = 0, r = a.length; e < r; e += 1) a[e].fn !== t && a[e].fn._ !== t &&
						o.push(a[e]);
	...
	"9pCYc": [function(e, t, r) {
		r.interopDefault = function(e) {
			...
			return Object.keys(e).forEach((function(r) {
				"default" === r || "__esModule" === r || t.hasOwnProperty(r) || Object
					.defineProperty(t, r, {
						enumerable: !0,
						get: function() {
							return e[r]
	...
	bSNiV: [function(e, t, r) {
		var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
		a.defineInteropFlag(r), a.export(r, "query", (() => n)), a.export(r, "queryAll", (() => i)), a
			.export(r, "addClass", (() => s)), a.export(r, "removeClass", (() => l)), a.export(r,
				"hasClass", (() => c)), a.export(r, "append", (() => p)), a.export(r, "remove", (() => u)),
			a.export(r, "setStyle", (() => d)), a.export(r, "setStyles", (() => f)), a.export(r, "getStyle",
				(() => h)), a.export(r, "sublings", (() => m)), a.export(r, "inverseClass", (() => g)), a
			.export(r, "tooltip", (() => v)), a.export(r, "isInViewport", (() => y)), a.export(r,
				"includeFromEvent", (() => b)), a.export(r, "replaceElement", (() => x)), a.export(r,
				"createElement", (() => w)), a.export(r, "getIcon", (() => j));
		...
		function p(e, t) {
			return t instanceof Element ? e.appendChild(t) : e.insertAdjacentHTML("beforeend", String(t)), e
	...
	"6ZTr6": [function(e, t, r) {
		var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
		a.defineInteropFlag(r), a.export(r, "userAgent", (() => o)), a.export(r, "isSafari", (() => n)), a
			.export(r, "isWechat", (() => i)), a.export(r, "isIE", (() => s)), a.export(r, "isAndroid", (
			() => l)), a.export(r, "isIOS", (() => c)), a.export(r, "isIOS13", (() => p)), a.export(r,
				"isMobile", (() => u));
	...
	hwmZz: [function(e, t, r) {
		var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
		a.defineInteropFlag(r), a.export(r, "ArtPlayerError", (() => o)), a.export(r, "errorHandle", (() =>
			n));
		class o extends Error {
			constructor(e, t) {
				super(e), "function" == typeof Error.captureStackTrace && Error.captureStackTrace(this,
					t || this.constructor), this.name = "ArtPlayerError"
			}
		}
	...
	inzwq: [function(e, t, r) {
		...
		function o(e) {
			return "WEBVTT \r\n\r\n".concat((t = e, t.replace(/(\d\d:\d\d:\d\d)[,.](\d+)/g, ((e, t, r) => {
					let a = r.slice(0, 3);
					return 1 === r.length && (a = r + "00"), 2 === r.length && (a = r +
						"0"), `${t},${a}`
				}))).replace(/\{\\([ibu])\}/g, "</$1>").replace(/\{\\([ibu])1\}/g, "<$1>").replace(
					/\{([ibu])\}/g, "<$1>").replace(/\{\/([ibu])\}/g, "</$1>").replace(
					/(\d\d:\d\d:\d\d),(\d\d\d)/g, "$1.$2").replace(/{[\s\S]*?}/g, "").concat(
				"\r\n\r\n"));
			var t
		}
		...
		a.defineInteropFlag(r), a.export(r, "srtToVtt", (() => o)), a.export(r, "vttToBlob", (() => n)), a
			.export(r, "assToVtt", (() => i))
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
	}],
	"6b7Ip": [function(e, t, r) {
		...
		function o(e) {
			return e.includes("?") ? o(e.split("?")[0]) : e.includes("#") ? o(e.split("#")[0]) : e.trim()
				.toLowerCase().split(".").pop()
		}

		function n(e, t) {
			const r = document.createElement("a");
			r.style.display = "none", r.href = e, r.download = t, document.body.appendChild(r), r.click(),
	...
	"5NSdr": [function(e, t, r) {
		var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
		a.defineInteropFlag(r), a.export(r, "def", (() => o)), a.export(r, "has", (() => i)), a.export(r,
			"get", (() => s)), a.export(r, "mergeDeep", (() => l));
		...
		function l(...e) {
			...
			return e.reduce(((e, r) => (Object.keys(r).forEach((a => {
				const o = e[a],
					n = r[a];
				Array.isArray(o) && Array.isArray(n) ? e[a] = o.concat(...n) : t(
					o) && t(n) ? e[a] = l(o, n) : e[a] = n
			})), e)), {})
		}
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
	...
	epmNy: [function(e, t, r) {
		...
		a.defineInteropFlag(r), a.export(r, "sleep", (() => o)), a.export(r, "debounce", (() => n)), a
			.export(r, "throttle", (() => i))
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
	}],
	gapRl: [function(e, t, r) {
		...
		a.defineInteropFlag(r), a.export(r, "clamp", (() => o)), a.export(r, "capitalize", (() => n)), a
			.export(r, "isStringOrNumber", (() => i)), a.export(r, "secondToTime", (() => s)), a.export(r,
				"escape", (() => l))
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
	}],
	AKEiO: [function(e, t, r) {
		...
		function u(e, t, r) {
			return (0, o.errorHandle)(t === s || t === l || e instanceof Element,
		...
		r.default = {
			...
			controls: [{
				...
				position: (e, t, r) => {
					...
					return (0, o.errorHandle)(a.includes(e),
	...
	lyjeQ: [function(e, t, r) {
		e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = {
			propertys: ["audioTracks", "autoplay", "buffered", "controller", "controls", "crossOrigin",
				"currentSrc", "currentTime", "defaultMuted", "defaultPlaybackRate", "duration",
				"ended", "error", "loop", "mediaGroup", "muted", "networkState", "paused",
				"playbackRate", "played", "preload", "readyState", "seekable", "seeking", "src",
				"startDate", "textTracks", "videoTracks", "volume"
			],
			methods: ["addTextTrack", "canPlayType", "load", "play", "pause"],
			events: ["abort", "canplay", "canplaythrough", "durationchange", "emptied", "ended",
			...
			prototypes: ["width", "height", "videoWidth", "videoHeight", "poster",
				"webkitDecodedFrameCount", "webkitDroppedFrameCount", "playsInline",
				"webkitSupportsFullscreen", "webkitDisplayingFullscreen", "onenterpictureinpicture",
				"onleavepictureinpicture", "disablePictureInPicture", "cancelVideoFrameCallback",
				"requestVideoFrameCallback", "getVideoPlaybackQuality", "requestPictureInPicture",
				"webkitEnterFullScreen", "webkitEnterFullscreen", "webkitExitFullScreen",
		...
		class o {
			constructor(e) {
				...
				t.container instanceof Element ? this.$container = t.container : (this.$container = (0,
					a.query)(t.container), (0, a.errorHandle)(this.$container,
					`No container element found by ${t.container}`));
				const o = this.$container.tagName.toLowerCase();
				(0, a.errorHandle)("div" === o,
					`Unsupported container element type, only support 'div' but got '${o}'`), (0, a
					.errorHandle)(r.instances.every((e => e.template.$container !== this.$container)),
					"Cannot mount multiple instances on the same dom element"), this.query = this.query
					.bind(this), this.$container.dataset.artId = e.id, this.$original = this.$container
					.cloneNode(!0), this.init()
			}
			static get html() {
			...
			init() {
				...
				e.useSSR || (this.$container.innerHTML = o.html), this.$player = this.query(
						".art-video-player"), this.$video = this.query(".art-video"), this.$track = this
					.query("track"), this.$poster = this.query(".art-poster"), this.$subtitle = this
					.query(".art-subtitle"), this.$danmuku = this.query(".art-danmuku"), this.$bottom =
					this.query(".art-bottom"), this.$progress = this.query(".art-progress"), this
					.$controls = this.query(".art-controls"), this.$controlsLeft = this.query(
						".art-controls-left"), this.$controlsCenter = this.query(
					".art-controls-center"), this.$controlsRight = this.query(".art-controls-right"),
					this.$layer = this.query(".art-layers"), this.$loading = this.query(".art-loading"),
					this.$notice = this.query(".art-notice"), this.$noticeInner = this.query(
						".art-notice-inner"), this.$mask = this.query(".art-mask"), this.$state = this
					.query(".art-state"), this.$setting = this.query(".art-settings"), this.$info = this
					.query(".art-info"), this.$infoPanel = this.query(".art-info-panel"), this
					.$infoClose = this.query(".art-info-close"), this.$contextmenu = this.query(
						".art-contextmenus"), e.backdrop && (0, a.addClass)(this.$player,
						"art-backdrop"), a.isMobile && (0, a.addClass)(this.$player, "art-mobile")
			}
			destroy(e) {
				e ? (0, a.replaceElement)(this.$original, this.$container) : (0, a.addClass)(this
					.$player, "art-destroy")
			}
		}
		r.default = o
	...
	a90nx: [function(e, t, r) {
		...
		r.default = class {
			constructor(e) {
				(0, n.default)(e), (0, s.default)(e), (0, c.default)(e), (0, u.default)(e), (0, f
					.default)(e), (0, m.default)(e), (0, v.default)(e), (0, b.default)(e), (0, w
					.default)(e), (0, k.default)(e), (0, I.default)(e), (0, P.default)(e), (0, M
					.default)(e), (0, E.default)(e), (0, A.default)(e), (0, H.default)(e), (0, R
					.default)(e), (0, L.default)(e), (0, N.default)(e), (0, _.default)(e), (0, q
					.default)(e), (0, U.default)(e), (0, G.default)(e), (0, X.default)(e), (0, Q
					.default)(e), (0, te.default)(e), (0, ae.default)(e), (0, ne.default)(e), (0, se
					.default)(e), (0, ce.default)(e), (0, ue.default)(e), (0, fe.default)(e), (0, me
					.default)(e), (0, be.default)(e), (0, ve.default)(e)
			}
		}
	}, {
		"./urlMix": "kQoac",
				...
				async set(o) {
					if (o) {
						const n = e.url,
							...
							s = t.customType[i];
						i && s ? (await (0, a.sleep)(), e.loading.show = !0, s.call(e, r, o,
							e)) : (URL.revokeObjectURL(n), r.src = o), n !== e.url && (e.option
								.url = o, e.isReady && n && e.once("video:canplay", (() => {
									e.emit("restart", o)
								})))
	...
	koAPr: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "seek", {
				set(r) {
					e.currentTime = r, e.emit("seek", e.currentTime), e.duration && (t.show =
						`${(0,a.secondToTime)(e.currentTime)} / ${(0,a.secondToTime)(e.duration)}`
						)
				}
			}), (0, a.def)(e, "forward", {
				set(t) {
	...
	"6eyuR": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "volume", {
				get: () => t.volume || 0,
				set: e => {
					t.volume = (0, a.clamp)(e, 0, 1), o.show =
						`${r.get("Volume")}: ${parseInt(100*t.volume,10)}`, 0 !== t.volume && n
						.set("volume", t.volume)
				}
			}), (0, a.def)(e, "muted", {
				get: () => t.muted,
	...
	faaWv: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "currentTime", {
				get: () => t.currentTime || 0,
				set: r => {
					r = parseFloat(r), Number.isNaN(r) || (t.currentTime = (0, a.clamp)(r, 0, e
						.duration))
				}
			})
		}
		...
		r.default = function(e) {
			function t(t, r) {
				return new Promise(((a, o) => {
					...
					e.pause(), e.url = t, e.notice.show = "", e.once("video:error", o), e
						.once("video:canplay", (async () => {
							e.playbackRate = s, e.aspectRatio = i, e
								.currentTime = r, n && await e.play(), e.notice
								.show = "", a()
						}))
				}))
			}(0, a.def)(e, "switchQuality", {
			...
			(0, a.def)(e, "playbackRate", {
				...
				set(a) {
					if (a) {
						...
						t.playbackRate = a, o.show =
							`${r.get("Rate")}: ${1===a?r.get("Normal"):`${a}x`}`
	...
	jihET: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "aspectRatio", {
				...
				set(i) {
					if (i || (i = "default"), "default" === i)(0, a.setStyle)(o, "width", null),
						(0, a.setStyle)(o, "height", null), (0, a.setStyle)(o, "margin", null),
						...
						const e = i.split(":").map(Number),
							...
							s = t / r,
							l = e[0] / e[1];
						s > l ? ((0, a.setStyle)(o, "width", l * r + "px"), (0, a.setStyle)(o,
							"height", "100%"), (0, a.setStyle)(o, "margin", "0 auto")) : ((
							0, a.setStyle)(o, "width", "100%"), (0, a.setStyle)(o,
							"height", t / l + "px"), (0, a.setStyle)(o, "margin",
							"auto 0")), n.dataset.aspectRatio = i
					}
					r.show = `${t.get("Aspect Ratio")}: ${"default"===i?t.get("Default"):i}`, e
						.emit("aspectRatio", i)
				}
			})
		}
	...
	"36kPY": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			} = e, o = (0, a.createElement)("canvas");
			(0, a.def)(e, "getDataURL", {
				value: () => new Promise(((e, a) => {
					try {
						o.width = r.videoWidth, o.height = r.videoHeight, o.getContext(
							"2d").drawImage(r, 0, 0), e(o.toDataURL("image/png"))
					} catch (e) {
						t.show = e, a(e)
					}
				}))
				...
				value: async () => {
					...
					return (0, a.download)(t,
						`artplayer_${(0,a.secondToTime)(r.currentTime)}.png`), e.emit(
						"screenshot", t), t
				}
			})
		}
	...
	"2GYOJ": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			e.once("video:loadedmetadata", (() => {
				n.default.isEnabled ? (e => {
					n.default.on("change", (() => {
						e.emit("fullscreen", n.default.isFullscreen)
					})), (0, i.def)(e, "fullscreen", {
						get: () => n.default.isFullscreen,
						async set(t) {
							t ? (e.state = "fullscreen", await n.default
								.request(o), (0, i.addClass)(o,
									"art-fullscreen")) : (await n
								.default.exit(), (0, i.removeClass)(
									o, "art-fullscreen")), e.emit(
								"resize")
						}
					})
				})(e) : document.fullscreenEnabled || a.webkitSupportsFullscreen ? (
				e => {
					(0, i.def)(e, "fullscreen", {
						get: () => a.webkitDisplayingFullscreen,
						set(t) {
							t ? (e.state = "fullscreen", a
								.webkitEnterFullscreen(), e.emit(
									"fullscreen", !0)) : (a
								.webkitExitFullscreen(), e.emit(
									"fullscreen", !1)), e.emit("resize")
						}
					})
				})(e) : (0, i.def)(e, "fullscreen", {
					get: () => !1,
					set() {
	...
	"5aYAP": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "fullscreenWeb", {
				...
				set(i) {
					i ? (n = o.style.cssText, t.FULLSCREEN_WEB_IN_BODY && (0, a.append)(document
							.body, o), e.state = "fullscreenWeb", (0, a.setStyle)(o,
							"width", "100%"), (0, a.setStyle)(o, "height", "100%"), (0, a
							.addClass)(o, "art-fullscreen-web"), e.emit("fullscreenWeb", !
						0)) : (t.FULLSCREEN_WEB_IN_BODY && (0, a.append)(r, o), n && (o
						.style.cssText = n, n = ""), (0, a.removeClass)(o,
						"art-fullscreen-web"), e.emit("fullscreenWeb", !1)), e.emit(
						"resize")
				}
			})
		}
	...
	"7EnIB": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			document.pictureInPictureEnabled ? function(e) {
				...
				t.disablePictureInPicture = !1, (0, a.def)(e, "pip", {
			...
			}(e) : o.webkitSupportsPresentationMode ? function(e) {
				const {
					$video: t
				} = e.template;
				t.webkitSetPresentationMode("inline"), (0, a.def)(e, "pip", {
					get: () => "picture-in-picture" === t.webkitPresentationMode,
					set(r) {
						r ? (e.state = "pip", t.webkitSetPresentationMode(
							"picture-in-picture"), e.emit("pip", !0)) : (t
							.webkitSetPresentationMode("inline"), e.emit("pip", !1))
					}
				})
			}(e) : (0, a.def)(e, "pip", {
				get: () => !1,
			...
			(0, a.def)(e, "autoSize", {
				value() {
					const {
						...
						width: s,
						height: l
					} = t.getBoundingClientRect(), c = n / i;
					if (s / l > c) {
						const e = l * c / s * 100;
						(0, a.setStyle)(r, "width", `${e}%`), (0, a.setStyle)(r, "height", "100%")
					} else {
						const e = s / c / l * 100;
						(0, a.setStyle)(r, "width", "100%"), (0, a.setStyle)(r, "height", `${e}%`)
					}
					e.emit("autoSize", {
						width: e.width,
						height: e.height
	...
	"7E7Vs": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "flip", {
				...
				set(n) {
					n || (n = "normal"), "normal" === n ? delete t.dataset.flip : t.dataset
						.flip = n, o.show =
						`${r.get("Video Flip")}: ${r.get((0,a.capitalize)(n))}`, e.emit("flip",
							n)
				}
			})
		}
	...
	gpugx: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			function p() {
				...
				t && ((0, a.removeClass)(n, "art-mini"), (0, a.setStyle)(t, "display", "none"), n
					.prepend(i), e.emit("mini", !1))
			}

			function u(t, r) {
				e.playing ? ((0, a.setStyle)(t, "display", "none"), (0, a.setStyle)(r, "display",
					"flex")) : ((0, a.setStyle)(t, "display", "flex"), (0, a.setStyle)(r, "display",
					"none"))
			}
			...
			function d() {
				const {
					$mini: t
				} = e.template, r = t.getBoundingClientRect(), n = window.innerHeight - r.height - 50,
					i = window.innerWidth - r.width - 50;
				o.set("top", n), o.set("left", i), (0, a.setStyle)(t, "top", `${n}px`), (0, a.setStyle)(
					t, "left", `${i}px`)
			}(0, a.def)(e, "mini", {
				...
				set(f) {
					if (f) {
						...
						const f = function() {
								...
								if (n) return (0, a.append)(n, i), (0, a.setStyle)(n, "display",
									"flex"); {
									const n = (0, a.createElement)("div");
									(0, a.addClass)(n, "art-mini-popup"), (0, a.append)(document
										.body, n), e.template.$mini = n, (0, a.append)(n, i);
									const d = (0, a.append)(n,
										'<div class="art-mini-close"></div>');
									(0, a.append)(d, t.close), r(d, "click", p);
									const f = (0, a.append)(n,
											'<div class="art-mini-state"></div>'),
										h = (0, a.append)(f, t.play),
										m = (0, a.append)(f, t.pause);
									return r(h, "click", (() => e.play())), r(m, "click", (() =>
											e.pause())), u(h, m), e.on("video:playing", (() =>
											u(h, m))), e.on("video:pause", (() => u(h, m))), e
										.on("video:timeupdate", (() => u(h, m))), r(n,
											"mousedown", (e => {
											...
											if (s) {
												...
												const t = e.pageX - l,
													r = e.pageY - c;
												(0, a.setStyle)(n, "transform",
													`translate(${t}px, ${r}px)`)
											}
										})), e.on("document:mouseup", (() => {
											if (s) {
												s = !1, (0, a.removeClass)(n,
													"art-mini-droging");
												const e = n.getBoundingClientRect();
												o.set("left", e.left), o.set("top", e
													.top), (0, a.setStyle)(n,
													"left", `${e.left}px`), (0, a
													.setStyle)(n, "top",
													`${e.top}px`), (0, a.setStyle)(
													n, "transform", null)
											}
										})), n
								}
							...
							h = o.get("top"),
							m = o.get("left");
						h && m ? ((0, a.setStyle)(f, "top", `${h}px`), (0, a.setStyle)(f,
							"left", `${m}px`), (0, a.isInViewport)(f) || d()) : d(), e.emit(
							"mini", !0)
					} else p()
				}
			})
	...
	f1hVG: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "loop", {
				get: () => t,
				set: r => {
					if (Array.isArray(r) && "number" == typeof r[0] && "number" == typeof r[
						1]) {
				...
				t.length && (e.currentTime < t[0] || e.currentTime > t[1]) && (e.seek = t[
					0])
			}))
		}
	}, {
	...
	"1CaTA": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			(0, a.def)(e, "cssVar", {
				value: (e, r) => r ? t.style.setProperty(e, r) : getComputedStyle(t)
					.getPropertyValue(e)
			})
		}
	}, {
					...
					if (o.$track && o.$track.track) {
						...
						for (let r = 0; r < l.length; r++) {
							...
							s[r] || (s[r] = {
									...
									endTime: a.endTime
								}), a.startTime = t(s[r].startTime + i, 0, e.duration), a
								.endTime = t(s[r].endTime + i, 0, e.duration)
						}
						e.subtitle.update(), r.show = `${n.get("Subtitle Offset")}: ${a}s`,
	...
	eftqT: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			let i = !0;
			window.WebKitPlaybackTargetAvailabilityEvent && n.webkitShowPlaybackTargetPicker ? o(n,
				...
				})) : i = !1, (0, a.def)(e, "airplay", {
				value() {
					i ? (n.webkitShowPlaybackTargetPicker(), e.emit("airplay")) : r.show = t
						.get("AirPlay Not Available")
				}
			})
		}
	}, {
			...
			(0, a.def)(e, "quality", {
				set(t) {
					...
					r.update({
						...
						selector: t,
						async onSelect(t) {
							await e.switchQuality(t.url), a.show =
								`${o.get("Switch Video")}: ${t.html}`
						}
					})
				}
			})
	...
	fCWZK: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			t.muted && (e.muted = t.muted), t.volume && (o.volume = (0, a.clamp)(t.volume, 0, 1));
			const i = r.get("volume");
			"number" == typeof i && (o.volume = (0, a.clamp)(i, 0, 1)), t.poster && (0, a.setStyle)(n,
					"backgroundImage", `url(${t.poster})`), t.autoplay && (o.autoplay = t.autoplay), t
				.playsInline && (o.playsInline = !0, o["webkit-playsinline"] = !0), t.theme && (t
					.cssVar["--art-theme"] = t.theme);
	...
	f8Lv3: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			let u = 0;
			for (let t = 0; t < n.default.events.length; t++) s(c, n.default.events[t], (t => {
				e.emit(`video:${t.type}`, t)
			}));
			e.on("video:canplay", (() => {
				u = 0, e.loading.show = !1
			})), e.once("video:canplay", (() => {
				e.loading.show = !1, e.controls.show = !0, e.mask.show = !0, e.isReady = !0,
					e.emit("ready")
			})), e.on("video:ended", (() => {
				a.loop ? (e.seek = 0, e.play(), e.controls.show = !1, e.mask.show = !1) : (e
					.controls.show = !0, e.mask.show = !0)
			})), e.on("video:error", (async n => {
				u < o.RECONNECT_TIME_MAX ? (await (0, i.sleep)(o.RECONNECT_SLEEP_TIME),
					u += 1, e.url = a.url, r.show = `${t.get("Reconnect")}: ${u}`, e
					.emit("error", n, u)) : (e.mask.show = !0, e.loading.show = !1,
					e.controls.show = !0, (0, i.addClass)(l, "art-error"), await (0,
						i.sleep)(o.RECONNECT_SLEEP_TIME), r.show = t.get(
						"Video Load Failed"), e.destroy(!1))
			})), e.on("video:loadedmetadata", (() => {
				e.emit("resize"), i.isMobile && (e.loading.show = !1, e.controls.show = !0,
					e.mask.show = !0)
		...
		class E extends i.default {
			constructor(e) {
				...
				t(a, ["click", "mousemove", "touchstart", "touchmove"], (() => {
					this.show = !0, (0, o.removeClass)(a, "art-hide-cursor"), (0, o
						.addClass)(a, "art-hover"), n = Date.now()
				})), e.on("video:timeupdate", (() => {
					!e.isInput && e.playing && this.show && Date.now() - n >= r
						.CONTROL_HIDE_TIME && (this.show = !1, (0, o.addClass)(a,
							"art-hide-cursor"), (0, o.removeClass)(a, "art-hover"))
				})), this.init()
			}
			init() {
				const {
				...
				e.isLive || this.add((0, g.default)({
					...
					position: "top",
					index: 10
				})), !e.thumbnails.url || e.isLive || o.isMobile || this.add((0, S.default)({
					name: "thumbnails",
					position: "top",
					index: 20
				})), this.add((0, $.default)({
					...
					position: "left",
					index: 30
				})), e.quality.length && (0, o.sleep)().then((() => {
					this.art.quality = e.quality
				})), e.screenshot && !o.isMobile && this.add((0, C.default)({
					name: "screenshot",
					position: "right",
					index: 20
					...
					position: "right",
					index: 40
				})), e.airplay && window.WebKitPlaybackTargetAvailabilityEvent && this.add((0, T
					.default)({
					name: "airplay",
					position: "right",
					index: 50
				})), e.fullscreenWeb && this.add((0, p.default)({
					name: "fullscreenWeb",
					position: "right",
					index: 60
	...
	"18nVI": [function(e, t, r) {
		...
		r.default = class {
			constructor(e) {
				this.id = 0, this.art = e, this.cache = new Map, this.add = this.add.bind(this),
					this.remove = this.remove.bind(this), this.update = this.update.bind(this)
			}
			get show() {
			...
			add(e) {
				const t = "function" == typeof e ? e(this.art) : e;
				if (t.html = t.html || "", (0, l.default)(t, c.ComponentOption), !this.$parent || !
					this.name || t.disable) return;
				const r = t.name || `${this.name}${this.id}`,
					a = this.cache.get(r);
				(0, i.errorHandle)(!a, `Can't add an existing [${r}] to the [${this.name}]`), this
					.id += 1;
				...
				const p = s.find((e => Number(e.dataset.index) >= Number(n.dataset.index)));
				p ? p.insertAdjacentElement("beforebegin", n) : (0, o.append)(this.$parent, n), t
					.html && (0, o.append)(n, t.html), t.style && (0, o.setStyles)(n, t.style), t
					.tooltip && (0, o.tooltip)(n, t.tooltip);
				const u = [];
				if (t.click) {
				...
				return t.selector && ["left", "right"].includes(t.position) && this.addSelector(t,
					n, u), this[r] = n, this.cache.set(r, {
					$ref: n,
					events: u,
					option: t
			...
			addSelector(e, t, r) {
				...
				(0, o.addClass)(s, "art-selector-value"), (0, o.append)(s, e.html), t.innerText =
					"", (0, o.append)(t, s);
				const l = e.selector.map(((e, t) =>
						`<div class="art-selector-item ${e.default?"art-current":""}" data-index="${t}">${e.html}</div>`
						)).join(""),
					c = (0, o.createElement)("div");
				(0, o.addClass)(c, "art-selector-list"), (0, o.append)(c, l), (0, o.append)(t, c);
				const p = () => {
					const e = (0, o.getStyle)(t, "width") / 2 - (0, o.getStyle)(c, "width") / 2;
					c.style.left = `${e}px`
				};
				a(t, p);
				const u = i(c, "click", (async t => {
					const r = (t.composedPath() || []).find((e => (0, o.hasClass)(e,
						"art-selector-item")));
					if (!r) return;
			...
			remove(e) {
				...
				(0, i.errorHandle)(t, `Can't find [${e}] from the [${this.name}]`), t.option
					.beforeUnmount && t.option.beforeUnmount.call(this.art, t.$ref);
			...
			return t => ({
				...
				mounted: e => {
					const {
						...
						icons: o,
						i18n: n
					} = t, i = (0, a.append)(e, o.fullscreenOn), s = (0, a.append)(e, o
						.fullscreenOff);
					(0, a.setStyle)(s, "display", "none"), r(e, "click", (() => {
						t.fullscreen = !t.fullscreen
					})), t.on("fullscreen", (t => {
						t ? ((0, a.tooltip)(e, n.get("Exit Fullscreen")), (0, a
							.setStyle)(i, "display", "none"), (0, a
							.setStyle)(s, "display", "inline-flex")) : ((0,
							a.tooltip)(e, n.get("Fullscreen")), (0, a
							.setStyle)(i, "display", "inline-flex"), (0,
			...
			return t => ({
				...
				mounted: e => {
					const {
						...
						icons: o,
						i18n: n
					} = t, i = (0, a.append)(e, o.fullscreenWebOn), s = (0, a.append)(e, o
						.fullscreenWebOff);
					(0, a.setStyle)(s, "display", "none"), r(e, "click", (() => {
						t.fullscreenWeb = !t.fullscreenWeb
					})), t.on("fullscreenWeb", (t => {
						t ? ((0, a.tooltip)(e, n.get("Exit Web Fullscreen")), (
							0, a.setStyle)(i, "display", "none"), (0, a
							.setStyle)(s, "display", "inline-flex")) : ((0,
							a.tooltip)(e, n.get("Web Fullscreen")), (0,
		...
		r.default = function(e) {
			return t => ({
				...
				mounted: e => {
					...
					(0, a.append)(e, o.pip), r(e, "click", (() => {
						t.pip = !t.pip
					})), t.on("pip", (t => {
						(0, a.tooltip)(e, n.get(t ? "Exit PIP Mode" :
							"PIP Mode"))
					}))
				}
			})
			...
			return t => ({
				...
				mounted: e => {
					const {
						...
						icons: o,
						i18n: n
					} = t, i = (0, a.append)(e, o.play), s = (0, a.append)(e, o.pause);

					function l() {
						(0, a.setStyle)(i, "display", "flex"), (0, a.setStyle)(s, "display",
							"none")
					}

					function c() {
						(0, a.setStyle)(i, "display", "none"), (0, a.setStyle)(s, "display",
							"flex")
					}(0, a.tooltip)(i, n.get("Play")), (0, a.tooltip)(s, n.get("Pause")), r(
						i, "click", (() => {
							t.play()
						})), r(s, "click", (() => {
						t.pause()
	...
	bgoVP: [function(e, t, r) {
		var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
		a.defineInteropFlag(r), a.export(r, "getPosFromEvent", (() => n)), a.export(r, "setCurrentTime", (
		() => i));
		var o = e("../utils");
		...
		function n(e, t) {
			const {
				...
				left: a
			} = r.getBoundingClientRect(), n = o.isMobile ? t.touches[0].clientX : t.clientX, i = (0, o
				.clamp)(n - a, 0, r.clientWidth), s = i / r.clientWidth * e.duration;
			return {
				second: s,
					...
					mounted: e => {
						...
						function m(e, t) {
							"loaded" === e && (0, o.setStyle)(p, "width", 100 * t + "%"),
								"played" === e && ((0, o.setStyle)(u, "width", 100 * t + "%"), (
									0, o.setStyle)(f, "left", 100 * t + "%"))
						}
						r.indicator ? (0, o.append)(f, r.indicator) : (0, o.setStyle)(f,
							"backgroundColor", "var(--art-theme)"), t.on(
							"video:loadedmetadata", (() => {
								for (let e = 0; e < a.highlight.length; e++) {
									const r = a.highlight[e],
										n = (0, o.clamp)(r.time, 0, t.duration) / t
										.duration * 100,
										i =
										`<span data-text="${r.text}" data-time="${r.time}" style="left: ${n}%"></span>`;
									(0, o.append)(d, i)
								}
							...
							! function(e) {
								...
								(0, o.setStyle)(c, "width", `${r}px`), (0, o
									.setStyle)(c, "display", "flex")
							}(r), (0, o.setStyle)(h, "display", "flex"), (0, o
								.includeFromEvent)(r, d) ? function(r) {
								const {
									width: a
								} = n(t, r), {
									text: i
								...
								a <= s / 2 ? (0, o.setStyle)(h, "left", 0) : a >
									e.clientWidth - s / 2 ? (0, o.setStyle)(h,
										"left", e.clientWidth - s + "px") : (0,
							...
							(0, o.setStyle)(h, "display", "none"), (0, o
		...
		r.default = function(e) {
			return t => ({
				...
				mounted: e => {
					function r() {
						const r =
							`${(0,a.secondToTime)(t.currentTime)} / ${(0,a.secondToTime)(t.duration)}`;
						r !== e.innerText && (e.innerText = r)
					}
					r();
					const o = ["video:loadedmetadata", "video:timeupdate",
					"video:progress"];
			...
			return t => ({
				...
				mounted: e => {
					const {
						proxy: r,
						icons: o
					} = t, n = (0, a.append)(e, o.volume), i = (0, a.append)(e, o
						.volumeClose), s = (0, a.append)(e,
						'<div class="art-volume-panel"></div>'), l = (0, a.append)(s,
						'<div class="art-volume-inner"></div>'), c = (0, a.append)(l,
						'<div class="art-volume-val"></div>'), p = (0, a.append)(l,
						'<div class="art-volume-slider"></div>'), u = (0, a.append)(p,
						'<div class="art-volume-handle"></div>'), d = (0, a.append)(u,
						'<div class="art-volume-loaded"></div>'), f = (0, a.append)(p,
					...
					function m() {
						if (t.muted || 0 === t.volume)(0, a.setStyle)(n, "display", "none"),
							(0, a.setStyle)(i, "display", "flex"), (0, a.setStyle)(f, "top",
								"100%"), (0, a.setStyle)(d, "top", "100%"), c.innerText = 0;
						else {
							const e = 100 * t.volume;
							(0, a.setStyle)(n, "display", "flex"), (0, a.setStyle)(i,
								"display", "none"), (0, a.setStyle)(f, "top", 100 - e +
							"%"), (0, a.setStyle)(d, "top", 100 - e + "%"), c.innerText =
								Math.floor(e)
						}
					}
					if (m(), t.on("video:volumechange", m), r(n, "click", (() => {
							t.muted = !0
						})), r(i, "click", (() => {
							t.muted = !1
		...
		r.default = function(e) {
			return t => ({
				...
				mounted: e => {
					...
					(0, a.append)(e, o.setting), r(e, "click", (() => {
						t.setting.toggle(), t.setting.updateStyle()
					})), t.on("setting", (t => {
						(0, a.tooltip)(e, n.get(t ? "Hide Setting" :
							"Show Setting"))
					}))
				}
			})
			...
			return t => ({
				...
				mounted: e => {
					...
					s(n, "mousemove", (async s => {
						...
						u && ((0, a.setStyle)(e, "display", "flex"),
							function(s) {
								const {
									width: l
								} = (0, o.getPosFromEvent)(t, s), {
									url: p,
									number: u,
									column: d,
									width: f,
									...
									.naturalWidth / d, g = h || m / (i
										.videoWidth / i.videoHeight),
									v = n.clientWidth / u, y = Math
									.floor(l / v), b = Math.ceil(y /
									d) - 1, x = y % d || d - 1;
								(0, a.setStyle)(e, "backgroundImage",
									`url(${p})`), (0, a.setStyle)(e,
									"height", `${g}px`), (0, a.setStyle)
								(e, "width", `${m}px`), (0, a.setStyle)(
									e, "backgroundPosition",
									`-${x*m}px -${b*g}px`), l <= m / 2 ?
									(0, a.setStyle)(e, "left", 0) : l >
									n.clientWidth - m / 2 ? (0, a
										.setStyle)(e, "left", n
										.clientWidth - m + "px") : (0, a
										.setStyle)(e, "left", l - m /
										2 + "px")
							}(s))
					})), s(n, "mouseleave", (() => {
		...
		r.default = function(e) {
			return t => ({
				...
				mounted: e => {
					...
					(0, a.append)(e, o.screenshot), r(e, "click", (() => {
						t.screenshot()
					}))
				}
			})
	...
	"2hIff": [function(e, t, r) {
		...
		r.default = function(e) {
			return t => ({
				...e,
				mounted: e => {
					const r = (0, a.append)(e, '<span class="art-loop-point"></span>'),
						o = (0, a.append)(e, '<span class="art-loop-point"></span>');
					t.on("loop", (n => {
						n && n.length ? ((0, a.setStyle)(e, "display", "flex"),
							(0, a.setStyle)(r, "left",
								`calc(${n[0]/t.duration*100}% - ${r.clientWidth}px)`
								), (0, a.setStyle)(o, "left", n[1] / t
								.duration * 100 + "%")) : (0, a.setStyle)(e,
							"display", "none")
					}))
				}
			})
	...
	"2KYsr": [function(e, t, r) {
		...
		class b extends i.default {
			constructor(e) {
				super(e), this.name = "contextmenu", this.$parent = e.template.$contextmenu, o
					.isMobile || this.init()
			}
			init() {
				const {
				...
				t(r, "contextmenu", (e => {
					...
					let d = t - l,
						f = n - c;
					t + u > l + s && (d = s - u), n + p > c + i && (f = i - p), (0, o
						.setStyles)(a, {
						top: `${f}px`,
						left: `${d}px`
					})
			...
			return t => {
				const {
					...
					constructor: {
						...
						`<span data-value="${e}">${1===e?r.get("Normal"):e.toFixed(1)}</span>`))
					.join("");
				return {
					...e,
					...
					mounted: e => {
						...
						r && (0, a.inverseClass)(r, "art-current"), t.on("video:ratechange", (
						() => {
								const r = (0, a.queryAll)("span", e).find((e => Number(e
									.dataset.value) === t.playbackRate));
		...
		r.default = function(e) {
			return t => {
				const {
					...
					`<span data-value="${e}">${"default"===e?r.get("Default"):e}</span>`)).join(
					"");
				return {
					...e,
					...
					mounted: e => {
						...
						r && (0, a.inverseClass)(r, "art-current"), t.on("aspectRatio", (t => {
							const r = (0, a.queryAll)("span", e).find((e => e
								.dataset.value === t));
							r && (0, a.inverseClass)(r, "art-current")
						}))
					}
		...
		r.default = function(e) {
			return t => {
				const {
					...
					`<span data-value="${e}">${r.get((0,a.capitalize)(e))}</span>`)).join("");
				return {
					...e,
					...
					mounted: e => {
						...
						r && (0, a.inverseClass)(r, "art-current"), t.on("flip", (t => {
							const r = (0, a.queryAll)("span", e).find((e => e
								.dataset.value === t));
							r && (0, a.inverseClass)(r, "art-current")
						}))
	...
	eSWto: [function(e, t, r) {
		...
		class u extends i.default {
			constructor(e) {
				super(e), this.name = "subtitle", this.eventDestroy = () => null, this.init(e.option
					.subtitle);
				let t = !1;
				e.on("video:timeupdate", (() => {
					if (!this.url) return;
					const e = this.art.template.$video.webkitDisplayingFullscreen;
					"boolean" == typeof e && e !== t && (t = e, this.createTrack(e ?
						"subtitles" : "metadata", this.url))
				}))
			}
			get url() {
			...
			update() {
				...
				e.innerHTML = "", this.activeCue && (this.art.option.subtitle.escape ? e.innerHTML =
					this.activeCue.text.split(/\r?\n/).map((e => `<p>${(0,o.escape)(e)}</p>`))
					.join("") : e.innerHTML = this.activeCue.text, this.art.emit(
						"subtitleUpdate", this.activeCue.text))
			}
			async switch (e, t = {}) {
				const {
					i18n: r,
				...
				return t.name && (a.show = `${r.get("Switch Subtitle")}: ${t.name}`), i
			}
			createTrack(e, t) {
				const {
					template: r,
					...
					$video: n,
					$track: i
				} = r, s = (0, o.createElement)("track");
				s.default = !0, s.kind = e, s.src = t, s.track.mode = "hidden", this.eventDestroy(),
					(0, o.remove)(i), (0, o.append)(n, s), r.$track = s, this.eventDestroy = a(this
						.textTrack, "cuechange", (() => this.update()))
			}
			async init(e) {
				const {
					notice: t,
				...
				if ((0, l.default)(e, p.default.subtitle), e.url) return this.style(e.style), fetch(
					e.url).then((e => e.arrayBuffer())).then((t => {
					const r = new TextDecoder(e.encoding).decode(t);
					switch (this.art.emit("subtitleLoad", e.url), e.type || (0, o
							.getExt)(e.url)) {
						case "srt": {
				...
				})).then((e => (r.innerHTML = "", this.url === e || (URL.revokeObjectURL(
						this.url), this.createTrack("metadata", e), this.art
					.emit("subtitleSwitch", e)), e))).catch((e => {
					throw t.show = e, e
				}))
			}
		}
	...
	jo4S1: [function(e, t, r) {
		...
		r.default = class {
			constructor(e) {
				this.destroyEvents = [], this.proxy = this.proxy.bind(this), this.hover = this.hover
					.bind(this), this.loadImg = this.loadImg.bind(this), (0, i.default)(e, this), (
						0, l.default)(e, this), (0, p.default)(e, this), (0, d.default)(e, this), (
						0, h.default)(e, this), (0, g.default)(e, this), (0, y.default)(e, this)
			}
			proxy(e, t, r, a = {}) {
			...
			loadImg(e) {
				return new Promise(((t, r) => {
					...
					if (e instanceof HTMLImageElement) a = e;
						...
						if ("string" != typeof e) return r(new(0, o.ArtPlayerError)(
							"Unable to get Image"));
						a = new Image, a.src = e
					}
					if (a.complete) return t(a);
					this.proxy(a, "load", (() => t(a))), this.proxy(a, "error", (() =>
						r(new(0, o.ArtPlayerError)(
							`Failed to load Image: ${a.src}`))))
				}))
			}
			remove(e) {
	...
	"6UrCm": [function(e, t, r) {
		...
		r.default = function(e, t) {
			...
			t.proxy(document, ["click", "contextmenu"], (t => {
				(0, a.includeFromEvent)(t, o) ? (e.isInput = "INPUT" === t.target.tagName, e
					.isFocus = !0, e.emit("focus", t)) : (e.isInput = !1, e.isFocus = !1, e
					.emit("blur", t))
			}));
			let i = 0;
			t.proxy(n, "click", (t => {
				...
				o - i <= s ? (e.emit("dblclick", t), a.isMobile ? !e.isLock && l && e
					.toggle() : c && (e.fullscreen = !e.fullscreen)) : (e.emit("click",
					t), a.isMobile ? !e.isLock && n && e.toggle() : e.toggle()), i = o
			}))
		}
	}, {
		"../utils": "71aH7",
	...
	eDXPO: [function(e, t, r) {
		...
		r.default = function(e, t) {
			...
			e.on("resize", (() => {
				...
				"standard" === e.state && r.autoSize && e.autoSize(), e.aspectRatio = t, a
					.show = ""
			}));
			const n = (0, a.debounce)((() => e.emit("resize")), o.RESIZE_TIME);
			t.proxy(window, ["orientationchange", "resize"], (() => n())), screen && screen
				.orientation && screen.orientation.onchange && t.proxy(screen.orientation, "change", (
				() => n()))
		}
	}, {
		"../utils": "71aH7",
	...
	"95GtS": [function(e, t, r) {
		...
		function n(e, t, r, a) {
			...
			return s >= -45 && s < 45 ? i = 4 : s >= 45 && s < 135 ? i = 1 : s >= -135 && s < -45 ? i = 2 :
				(s >= 135 && s <= 180 || s >= -180 && s < -135) && (i = 3), i
		}
		r.default = function(e, t) {
			if (a.isMobile && !e.option.isLive) {
					...
					f = t => {
						if (1 === t.touches.length && l && e.duration) {
							const {
								pageX: o,
								pageY: i
							} = t.touches[0], l = n(c, p, o, i), d = [3, 4].includes(l), f = [1, 2]
								.includes(l);
							if (d && !e.isRotate || f && e.isRotate) {
								...
								e.seek = f, e.emit("setBar", "played", (0, a.clamp)(f / e.duration, 0,
										1)), e.notice.show =
									`${(0,a.secondToTime)(f)} / ${(0,a.secondToTime)(e.duration)}`
							}
						}
					},
					h = () => {
				...
				t.proxy(i, "touchstart", (e => {
					...
					s = r, d(e)
				})), t.proxy(r, "touchmove", f), t.proxy(i, "touchmove", f), t.proxy(document,
					"touchend", h)
			}
		}
	}, {
	...
	InUBx: [function(e, t, r) {
		...
		r.default = function(e, t) {
			...
			t.proxy(window, "scroll", (() => i())), e.on("view", (t => {
				r.autoMini && (e.mini = !t)
			}))
		}
	}, {
			...
			init() {
				...
				this.add(27, (() => {
					...
					if (this.art.isFocus) {
						...
						if ("INPUT" !== t && "TEXTAREA" !== t && "" !== r && "true" !==
							r) {
							const t = this.keys[e.keyCode];
							if (t) {
								e.preventDefault();
								for (let r = 0; r < t.length; r++) t[r].call(this.art,
									e);
	...
	dWGTw: [function(e, t, r) {
		...
		r.default = class {
			...
			set show(e) {
				...
				e ? (o.innerText = e instanceof Error ? e.message.trim() : e, (0, a.addClass)(r,
					"art-notice-show"), clearTimeout(this.timer), this.timer = setTimeout((
				() => {
		...
		class s extends i.default {
			constructor(e) {
				...
				const {
					...
					icons: r,
					events: a
				} = e, n = (0, o.append)(t.$state, r.state), i = (0, o.append)(t.$state, r.error);
				(0, o.setStyle)(i, "display", "none"), e.on("destroy", (() => {
					(0, o.setStyle)(n, "display", "none"), (0, o.setStyle)(i, "display",
						null)
	...
	"6OeNg": [function(e, t, r) {
		...
		r.default = class {
			constructor(e) {
				...
				for (const e in t)(0, o.def)(this, e, {
	...
	"3eYNH": [function(e, t, r) {
		...
		class g extends f.default {
			constructor(e) {
				...
				this.name = "setting", this.$parent = a, this.option = [], this.events = [], this
					.cache = new Map, t.setting && (this.init(), e.on("blur", (() => {
						...
						!this.show || t || a || (this.show = !1, this.render(this
							.option))
					})))
			}
			static makeRecursion(e, t, r) {
				for (let a = 0; a < e.length; a++) {
					const o = e[a];
					o.$parentItem = t, o.$parentList = r, g.makeRecursion(o.selector || [], o, e)
				}
				return e
			}
			get defaultSettings() {
				...
				return t.playbackRate && e.push((0, c.default)(this.art)), t.aspectRatio && e.push((
						0, s.default)(this.art)), t.flip && e.push((0, n.default)(this.art)), t
					.subtitleOffset && e.push((0, u.default)(this.art)), e
			}
			init() {
				const {
					option: e
			...
			remove(e) {
				...
				return r.splice(r.indexOf(t), 1), this.option = g.makeRecursion(this.option), this
					.destroy(), this.render(this.option), this.option
			}
			update(e) {
				const t = this.find(e.name);
				return t ? (Object.assign(t, e), this.option = g.makeRecursion(this.option), this
					.destroy(), this.render(this.option)) : this.add(e), this.option
			}
			add(e) {
				return this.option.push(e), this.option = g.makeRecursion(this.option), this
					.destroy(), this.render(this.option), this.option
			}
			creatHeader(e) {
				const {
				...
				(0, m.setStyle)(o, "height", `${a.SETTING_ITEM_HEIGHT}px`), (0, m.addClass)(o,
					"art-setting-item"), (0, m.addClass)(o, "art-setting-item-back");
				const n = (0, m.append)(o, '<div class="art-setting-item-left"></div>'),
					i = (0, m.createElement)("div");
				(0, m.addClass)(i, "art-setting-item-left-icon"), (0, m.append)(i, t.arrowLeft), (0,
					m.append)(n, i), (0, m.append)(n, e.$parentItem.html);
			...
			creatItem(e, t) {
				...
				(0, m.addClass)(n, "art-setting-item"), (0, m.setStyle)(n, "height",
					`${o.SETTING_ITEM_HEIGHT}px`), (0, m.isStringOrNumber)(t.name) && (n.dataset
					.name = t.name), (0, m.isStringOrNumber)(t.value) && (n.dataset.value = t
				.value);
				...
				switch ((0, m.addClass)(l, "art-setting-item-left-icon"), e) {
					case "switch":
					case "range":
						(0, m.append)(l, (0, m.isStringOrNumber)(t.icon) || t
							.icon instanceof Element ? t.icon : r.config);
						break;
					case "selector":
						t.selector && t.selector.length ? (0, m.append)(l, (0, m.isStringOrNumber)(t
							.icon) || t.icon instanceof Element ? t.icon : r.config) : (0, m
							.append)(l, r.check)
				}(0, m.append)(i, l), t.$icon = l, (0, m.def)(t, "icon", {
					configurable: !0,
					get: () => l.innerHTML,
					set(e) {
				...
				(0, m.addClass)(c, "art-setting-item-left-text"), (0, m.append)(c, t.html || ""), (
					0, m.append)(i, c), t.$html = c, (0, m.def)(t, "html", {
					configurable: !0,
					get: () => c.innerHTML,
					set(e) {
				...
				switch ((0, m.addClass)(p, "art-setting-item-right-tooltip"), (0, m.append)(p, t
						.tooltip || ""), (0, m.append)(s, p), t.$tooltip = p, (0, m.def)(t,
						"tooltip", {
							configurable: !0,
							get: () => p.innerHTML,
							set(e) {
					...
					case "switch": {
						...
						(0, m.setStyle)(t.switch ? o : a, "display", "none"), (0, m.append)(s, e), t
							.$switch = t.switch, (0, m.def)(t, "switch", {
								configurable: !0,
								get: () => t.$switch,
								set(e) {
									t.$switch = e, e ? ((0, m.setStyle)(o, "display",
											"none"), (0, m.setStyle)(a, "display",
										null)) : ((0, m.setStyle)(o, "display", null), (
					...
					case "range": {
						...
						r.value = t.range[0] || 0, r.min = t.range[1] || 0, r.max = t.range[2] ||
							10, r.step = t.range[3] || 1, (0, m.addClass)(r, "art-setting-range"), (
								0, m.append)(s, e), t.$range = r, (0, m.def)(t, "range", {
								configurable: !0,
								get: () => r.valueAsNumber,
								set(e) {
									r.value = Number(e)
					...
					case "selector":
						if (t.selector && t.selector.length) {
							const e = (0, m.createElement)("div");
							(0, m.addClass)(e, "art-setting-item-right-icon"), (0, m.append)(e, r
								.arrowRight), (0, m.append)(s, e)
						}
				}
				switch (e) {
					case "switch":
						...
						if (t.$range) {
							if (t.onRange) {
								const e = a(t.$range, "change", (async e => {
									t.tooltip = await t.onRange.call(this.art, t, n,
										e)
								}));
								this.events.push(e)
							}
							if (t.onChange) {
								const e = a(t.$range, "input", (async e => {
									t.tooltip = await t.onChange.call(this.art, t,
										n, e)
								}));
								this.events.push(e)
							}
					...
					case "selector": {
						const e = a(n, "click", (async e => {
							if (t.selector && t.selector.length) this.render(t
								.selector, t.width);
							else {
								(0, m.inverseClass)(n, "art-current");
								for (let e = 0; e < t.$parentItem.selector
									.length; e++) {
									const r = t.$parentItem.selector[e];
									r.default = r === t
								}
								if (t.$parentList && this.render(t.$parentList), t
									.$parentItem && t.$parentItem.onSelect) {
									const r = await t.$parentItem.onSelect.call(this
										.art, t, n, e);
									t.$parentItem.$tooltip && (0, m
										.isStringOrNumber)(r) && (t.$parentItem
										.$tooltip.innerHTML = r)
								}
							}
						}));
						this.events.push(e), t.default && (0, m.addClass)(n, "art-current")
					}
				}
				return n
			}
					...
					const n = e || r.SETTING_WIDTH,
						{
							left: i,
							width: s
						} = t.setting.getBoundingClientRect(),
						{
							left: l,
							width: c
						} = a.getBoundingClientRect(),
						p = i - l + s / 2 - n / 2;
					p + n > c ? ((0, m.setStyle)(o, "left", null), (0, m.setStyle)(o, "right",
						null)) : ((0, m.setStyle)(o, "left", `${p}px`), (0, m.setStyle)(o,
						"right", "auto"))
				}
			}
			render(e, t) {
				...
				if (this.cache.has(e)) {
					const t = this.cache.get(e);
					(0, m.inverseClass)(t, "art-current"), (0, m.setStyle)(this.$parent, "width",
						`${t.dataset.width}px`), (0, m.setStyle)(this.$parent, "height",
						`${t.dataset.height}px`), this.updateStyle(Number(t.dataset.width))
				} else {
					const a = (0, m.createElement)("div");
					(0, m.addClass)(a, "art-setting-panel"), a.dataset.width = t || r.SETTING_WIDTH,
						a.dataset.height = e.length * r.SETTING_ITEM_HEIGHT, e[0] && e[0]
						.$parentItem && ((0, m.append)(a, this.creatHeader(e[0])), a.dataset
							.height = Number(a.dataset.height) + r.SETTING_ITEM_HEIGHT);
					for (let t = 0; t < e.length; t++) {
						const r = e[t];
						(0, m.has)(r, "switch") ? (0, m.append)(a, this.creatItem("switch", r)) : (
							0, m.has)(r, "range") ? (0, m.append)(a, this.creatItem("range", r)) : (
							0, m.append)(a, this.creatItem("selector", r))
					}(0, m.append)(this.$parent, a), this.cache.set(e, a), (0, m.inverseClass)(a,
							"art-current"), (0, m.setStyle)(this.$parent, "width",
							`${a.dataset.width}px`), (0, m.setStyle)(this.$parent, "height",
							`${a.dataset.height}px`), this.updateStyle(Number(a.dataset.width)), e[
							0] && e[0].$parentItem && e[0].$parentItem.mounted && e[0].$parentItem
						.mounted.call(this.art, a, e[0].$parentItem)
				}
			}
		}
		r.default = g
	...
	kONUB: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			function i(e, r, o) {
				...
				const n = (0, a.queryAll)(".art-setting-item", e).find((e => e.dataset.value === o));
			...
			return {
				...
				mounted: (t, r) => {
					i(t, r.$tooltip, e.flip), e.on("flip", (() => {
	...
	"84NBV": [function(e, t, r) {
		...
		r.default = function(e) {
			...
			function s(e, t, r) {
				t && (t.innerText = i(r));
				const o = (0, a.queryAll)(".art-setting-item", e).find((e => e.dataset.value === r));
	...
	aetWt: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			function s(e, t, r) {
				t && (t.innerText = i(r));
				const o = (0, a.queryAll)(".art-setting-item", e).find((e => Number(e.dataset.value) ===
					r));
				o && (0, a.inverseClass)(o, "art-current")
			}
			return {
	...
	"8MTUM": [function(e, t, r) {
		...
		r.default = class {
			constructor(e) {
				...
				t.miniProgressBar && !t.isLive && this.add(i.default), t.lock && o.isMobile && this
					.add(h.default), t.autoPlayback && !t.isLive && this.add(p.default), t
					.autoOrientation && o.isMobile && this.add(l.default), t.fastForward && o
					.isMobile && !t.isLive && this.add(d.default);
			...
			add(e) {
				...
				return (0, o.errorHandle)(!(0, o.has)(this, r),
					`Cannot add a plugin that already has the same name: ${r}`), (0, o.def)(
					this, r, {
						value: t
					}), this
			}
			...
			return e.on("fullscreenWeb", (n => {
				if (n) {
					...
					(n > i && s < l || n < i && s > l) && setTimeout((() => {
						(0, a.setStyle)(r, "width", `${l}px`), (0, a.setStyle)(
							r, "height", `${s}px`), (0, a.setStyle)(r,
							"transform-origin", "0 0"), (0, a.setStyle)(r,
							"transform", `rotate(90deg) translate(0, -${s}px)`),
						(0, a.addClass)(r, "art-auto-orientation"), e
							.isRotate = !0, e.emit("resize")
					}), t.AUTO_ORIENTATION_TIME)
				} else(0, a.hasClass)(r, "art-auto-orientation") && ((0, a.removeClass)(r,
					"art-auto-orientation"), e.isRotate = !1, e.emit("resize"))
				...
				if (e) {
					...
					if (e > n && i < s || e < n && i > s) {
						...
						await screen.orientation.lock(e), (0, a.addClass)(r,
							"art-auto-orientation-fullscreen")
					}
				} else(0, a.hasClass)(r, "art-auto-orientation-fullscreen") && (
					await screen.orientation.lock(t), (0, a.removeClass)(r,
						"art-auto-orientation-fullscreen"))
			})), {
	...
	cVO99: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			}), c = (0, a.query)(".art-auto-playback-last", l), p = (0, a.query)(
				".art-auto-playback-jump", l), u = (0, a.query)(".art-auto-playback-close", l);
			return e.on("video:timeupdate", (() => {
				if (e.playing) {
					const t = o.get("times") || {},
						r = Object.keys(t);
					r.length > n.AUTO_PLAYBACK_MAX && delete t[r[0]], t[e.option.id || e
						.option.url] = e.currentTime, o.set("times", t)
				}
			})), e.on("ready", (() => {
				const d = (o.get("times") || {})[e.option.id || e.option.url];
				d && d >= n.AUTO_PLAYBACK_MIN && ((0, a.append)(u, r.close), (0, a.setStyle)
					(l, "display", "flex"), c.innerText =
					`${t.get("Last Seen")} ${(0,a.secondToTime)(d)}`, p.innerText = t
					.get("Jump Play"), i(u, "click", (() => {
						(0, a.setStyle)(l, "display", "none")
					})), i(p, "click", (() => {
						e.seek = d, e.play(), (0, a.setStyle)(s, "display",
							"none"), (0, a.setStyle)(l, "display", "none")
	...
	hFDwt: [function(e, t, r) {
		...
		r.default = function(e) {
			...
			let i = null,
				...
				l = 1;
			const c = () => {
				clearTimeout(i), s && (s = !1, e.playbackRate = l, (0, a.removeClass)(o,
					"art-fast-forward"))
			};
			return r(n, "touchstart", (r => {
				1 === r.touches.length && e.playing && !e.isLock && (i = setTimeout((() => {
					s = !0, l = e.playbackRate, e.playbackRate = t
						.FAST_FORWARD_VALUE, (0, a.addClass)(o,
							"art-fast-forward")
				}), t.FAST_FORWARD_TIME))
		...
		r.default = function(e) {
			...
			return t.add({
				...
				mounted(t) {
					...
					(0, a.setStyle)(o, "display", "none"), e.on("lock", (e => {
						e ? ((0, a.setStyle)(o, "display", "inline-flex"), (0, a
							.setStyle)(n, "display", "none")) : ((0, a.setStyle)
							(o, "display", "none"), (0, a.setStyle)(n,
								"display", "inline-flex"))
					}))
				},
				click() {
					(0, a.hasClass)(o, "art-lock") ? ((0, a.removeClass)(o, "art-lock"), this
						.isLock = !1, e.emit("lock", !1)) : ((0, a.addClass)(o, "art-lock"),
						this.isLock = !0, e.emit("lock", !0))
				}
			}), {
				name: "lock",
				get state() {
